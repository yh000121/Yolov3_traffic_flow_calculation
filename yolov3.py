...
class YOLO(object):
    _defaults = {
        "labelsPath" : 'D:/python_workspace1/python_workspace1/YOLOV3-SORT-master/yolo-coco/coco.names',   #"./yolo-coco/coco.names"
        "weightsPath" :'D:/python_workspace1/python_workspace1/YOLOV3-SORT-master/yolo-coco/yolov3.weights',  #"./yolo-coco/yolov3.weights",
        "configPath" : 'D:/python_workspace1/python_workspace1/YOLOV3-SORT-master/yolo-coco/yolov3.cfg',#"./yolo-coco/yolov3.cfg",
        "className" : "car",
        "threshold": 0.3,
    }
